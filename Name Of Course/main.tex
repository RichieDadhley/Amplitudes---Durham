...
\usepackage{footnote}\makesavenoteenv{leftbar}
...
\begin{titlepage}
	\centering
	    ...
	    Course delivered in 2020 by 
	
	    \vspace{0.5\baselineskip} % Whitespace before the editors
	
	    {\scshape\Large Dr. Arthur Lipstein} % Lecturer Name
	    ...
	    \textit{richie.s.dadhley@durham.ac.uk} % Email
...
These are my notes on the 2020 lecture course "Amplitudes" taught by Dr. Arthur Lipstein at Durham University as part of the Particles, Strings and Cosmology Msc. For reference, the course lasted 8 hours and was taught over 4 weeks. \\
...
I would like to extend a message of thanks to Dr. Lipstein for teaching this course. \\

If you have any comments and/or questions please feel free to contact me via the email provided on the title page. \\

These notes are now finished. If you have any comments and/or questions please feel free to contact me via the email provided on the title page. \\

For a list of other notes/works I have available, visit my blog site:

\begin{center}
    \href{www.richiedadhley.com}{www.richiedadhley.com}
\end{center}

These notes are not endorsed by Dr. Lipstein or Durham University.
...
\input{sections/01SpinorHelicity.tex}
\input{sections/02ColourOrdering.tex}
\input{sections/03nPoint.tex}
\input{sections/04BCFW.tex}
\input{sections/05Symmetries.tex}
